...
public class Escalator {
	...
	public void moveSteps() {
		System.out.println("Steps start moving");
	}

	public void stopSteps() {
		System.out.println("Steps stop moving");
	}

	public void enableSensor() {
		System.out.println("motion sensor enables");
	}

	public void disableSensor() {
		System.out.println("motion sensor disables");
	}
